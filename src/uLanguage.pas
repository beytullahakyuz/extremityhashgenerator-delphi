...
var
  folderbrowsertitle: string  = 'Lütfen bir klasör seçiniz...';
  filedialogtitle: string = 'Lütfen dosya(lar) seçiniz...';
  filefilter: string = 'Tüm Dosyalar (*.*)|*.*|' + 'Metin Dosyalarý (*.txt,*.lang)|*.txt;*.lang|' + 'Resim Dosyalarý (*.jpg,*.jpe,*.png,*.jpeg,*.bmp,*.tiff,*.tif,*.psd)|*.jpg;*.jpe;*.png;*.jpeg;*.bmp;*.tiff;*.tif;*.psd|' +
                         'Ses Dosyalarý (*.mp3,*.ogg,*.wav,*.mp2)|*.mp3;*.ogg;*.wav;*.mp2|' + 'Vidyo Files (*.wmv,*.avi,*.mp4,*.3gp,*.mkv,*.mpeg,*.mov)|*.wmv;*.avi;*.mp4;*.3gp;*.mkv;*.mpeg;*.mov';
  msgclearlist: string = 'Listeyi temizle?';
  msgemptylist: string = 'Liste boþ.';
  statustoplam: string = 'Listedeki toplam öðe sayýsý: ';
  statussecili: string = ', seçili öðe sayýsý: ';
  statusisaretli: string = ', iþaretli öðe sayýsý: ';
  statuscopyclipbrd: string = '';
  statuslistempty: string = 'Listede öðe bulunmamaktadýr.';
  contextdelete: string = 'Seçili öðeleri silmek istediðinize emin misiniz?';
  ctdel: string = '';
...
begin
  ...
  begin
    ...
    aboutformlbldeveloper := 'Developer: Beytullah AKYÜZ';
  ...
  if mylang = 'tr' then
  begin
    Form1.mainmenu2.Caption := 'Düzen';
    Form1.mainmenu3.Caption := 'Seçenekler';
    Form1.mainmenu4.Caption := 'Yardým';
    Form1.menuaddfolder.Caption := 'Klasör Ekle';
    Form1.menuaddfiles.Caption := 'Dosya(lar) Ekle';
    Form1.menusavewizard.Caption := 'Kaydetme Sihirbazý';
    Form1.menuexit.Caption := 'Çýkýþ';
    Form1.menuselect.Caption := 'Tümünü Seç';
    Form1.menudeselect.Caption := 'Tümünün Seçimini Kaldýr';
    Form1.menucheckall.Caption := 'Tümünü Ýþaretle';
    Form1.menuuncheckall.Caption := 'Tümünün Ýþaretini Kaldýr';
    Form1.menuclearlist.Caption := 'Listeyi Temizle';
    Form1.menutools.Caption := 'Araçlar';
    Form1.menutexthashgenerator.Caption := 'Metin Hash Oluþturucu';
    Form1.menusettings.Caption := 'Ayarlar';
    Form1.menulanguage.Caption := 'Dil';
    Form1.menualgorithms.Caption := 'Algoritmalar';
    Form1.menusystemdefault.Caption := 'Sistem Varsayýlan';
    Form1.menuturkish.Caption := 'Türkçe';
    Form1.menuenglish.Caption := 'Ýngilizce';
    Form1.menuthemes.Caption := 'Temalar';
    Form1.menuabouthashgenerator.Caption := 'Hakkýnda';
    Form1.menuselected.Caption := 'Seçilen öðeleri';
    Form1.menuclipboard.Caption := 'Panoya kopyala';
    Form1.contextcheck.Caption := 'Ýþaretle';
    Form1.contextuncheck.Caption := 'Ýþaretlerini Kaldýr';
    Form1.contextdelete.Caption := 'Sil';
    Form1.mylist1.Columns[0].Caption := 'Dosya Adý';
    Form1.mylist1.Columns[1].Caption := 'Konum';
    Form1.mylist1.Columns[2].Caption := 'Algoritma';
    Form1.mylist1.Columns[3].Caption := 'Deðer';
    Form1.menufonttype.Caption := 'Yazý Stili';
    Form1.menuuppercase.Caption := 'Büyük Harf';
    Form1.menulowercase.Caption := 'Küçük Harf';
    if params = 'default' then
      begin
        Form1.menusystemdefault.Checked := true;
        Form1.menusystemdefault.Default := true;
    ...
    folderbrowsertitle := 'Lütfen bir klasör seçiniz...';
    filedialogtitle := 'Lütfen dosya(lar) seçiniz...';
    filefilter := 'Tüm Dosyalar (*.*)|*.*|' + 'Metin Dosyalarý (*.txt,*.lang)|*.txt;*.lang|' + 'Resim Dosyalarý (*.jpg,*.jpe,*.png,*.jpeg,*.bmp,*.tiff,*.tif,*.psd)|*.jpg;*.jpe;*.png;*.jpeg;*.bmp;*.tiff;*.tif;*.psd|' +
                           'Ses Dosyalarý (*.mp3,*.ogg,*.wav,*.mp2)|*.mp3;*.ogg;*.wav;*.mp2|' + 'Vidyo Files (*.wmv,*.avi,*.mp4,*.3gp,*.mkv,*.mpeg,*.mov)|*.wmv;*.avi;*.mp4;*.3gp;*.mkv;*.mpeg;*.mov|' +
                           'Uygulama Dosyalarý (*.exe,*.dll,*.ocx,*.com,*.cmd,*.bat)|*.exe;*.dll;*.ocx;*.com;*.cmd;*.bat';
    msgclearlist := 'Listeyi temizle?';
    msgemptylist := 'Liste boþ';
    statustoplam := 'Listedeki öðelerin sayýsý: ';
    statusisaretli := ', iþaretli öðelerin sayýsý: ';
    statussecili := ', seçili öðelerin sayýsý: ';
    statuscopyclipbrd := ' deðeri baþarýyla kopyalandý';
    statuslistempty := 'Listede öðe bulunmamaktadýr';
    contextdelete := 'Seçili öðeleri silmek istediðinize emin misiniz?';
    contextdelete2  := 'Sil?';
    ctdel := 'Seçili öðeleri silmek istediðinize emin misiniz?';
    form3btnminimize := 'Küçült';
    form3btnmaximize := 'Büyült';
    form3btncancel := 'Ýptal';
    form3labelfilecount := 'Dosya sayýsý:';
    form3labelfilename := 'Dosya adý:';
    form3labeldirectory := 'Dizin:';
    form3labelcalchash := 'Hesaplanan hash deðeri:';
    form3status1 := 'Durum: Dosya sayýsý hesaplanýyor...';
    form3status2 := 'Durum: Hash deðerleri hesaplanýyor...';
    form3msgcancel := 'Ýþlemi iptal etmek istediðinize emin misiniz?';
    form3msgcancel2 := 'Ýptal?';
    form3caption := 'Hesaplanýyor... Lütfen bekleyin.';
    form4savedialogtitle := 'Lütfen konum seçiniz...';
    form4labellocation := 'Konum:';
    form4btnsavesettings := 'Ayarlarý Kaydet';
    form4btnsave := 'Kaydet';
    form4btncancel := 'Ýptal';
    form4caption := 'Kaydetme Sihirbazý';
    form4grup1 := 'Kaydetme ayarlarý';
    form4grup2 := 'Kaydetme seçenekleri';
    form4html := 'HTML Belgesi (*.html)|*.html|' + 'Zengin Metin Belgesi (*.rtf)|*.rtf';
    form4radiosaveall := 'Tümünü kaydet';
    form4radiosavechecked := 'Ýþaretlenen öðeleri kaydet';
    charsetlist.Add('big5 (Geleneksel Çince - Big5)');
    charsetlist.Add('euc-kr (Korece - EUC)');
    charsetlist.Add('iso-8859-1 (Batý Alfabe - ISO)');
    charsetlist.Add('iso-8859-2 (Orta Avrupa Alfabe - ISO)');
    charsetlist.Add('iso-8859-3 (Latin 3 Alfabe - ISO)');
    charsetlist.Add('iso-8859-4 (Baltýk Alfabe - ISO)');
    charsetlist.Add('iso-8859-5 (Kiril Alfabesi - ISO)');
    charsetlist.Add('iso-8859-6 (Arapça Alfabe - ISO)');
    charsetlist.Add('iso-8859-7 (Yunan Alfabesi - ISO)');
    charsetlist.Add('iso-8859-8 (Ýbrani Alfabesi - ISO)');
    ...
    form4labelsavetype := 'Kayýt türü:';
    form4msgwrite := 'Listedeki öðeler baþarýyla kaydedildi.';
    form4msgwritetitle := 'Kayýt Bilgi';
    aboutformlblversion := 'Sürüm: 1.1';
    aboutformlbldescription := 'Bu program Extremity Software firmasý tarafýndan geliþtirilmiþtir.' + sLineBreak + 'Kullanýmý ücretsiz, kopyalanmasý ve izinsiz daðýtýlmasý yasaktýr.';
    aboutformlbldeveloper := 'Geliþtirici: Beytullah AKYÜZ';
    aboutformlblcopyright := 'Telif Hakký © 2012 - 2021 Extremity Software';
    aboutformcaption := 'Hakkýnda';
    mainforminfo := 'Yapým aþamasýndadýr';
    mainforminfotitle := 'Bilgi';
    form2lbltext := 'Metin:';
    form2lblmd2 := 'MD2 hash deðeri:';
    form2lblmd4 := 'MD4 hash deðeri:';
    form2lblmd5 := 'MD5 hash deðeri:';
    form2lblsha1 := 'SHA1 hash deðeri:';
    form2lblsha224 := 'SHA224 hash deðeri:';
    form2lblsha256 := 'SHA256 hash deðeri:';
    form2lblsha384 := 'SHA384 hash deðeri:';
    form2lblsha512 := 'SHA512 hash deðeri:';
    form2lblsha512_224 := 'SHA2-512/224 hash deðeri:';
    form2lblsha512_256 := 'SHA2-512/256 hash deðeri:';
    form2lblcrc16 := 'CRC16 hash deðeri:';
    form2lblcrc32 := 'CRC32 hash deðeri:';
    form2caption := 'Metin Hash Oluþturucu';
  end;
  Form1.listcalc;
